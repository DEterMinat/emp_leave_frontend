...
const employeeDashboardData = {
    ...
    leaveBalances: [
        ...
        { type: "Ordination Leave", used: 0, total: 30, color: "bg-indigo-400", icon: "hands" }, // ลาอุปสมบท [cite: 48, 66]
        { type: "Unpaid Leave", used: 0, total: 120, color: "bg-gray-400", icon: "dollar-sign" }
    ],
    recentRequests: [
