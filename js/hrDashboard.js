...
function renderLeaveBalances(leaves, entitlements = null) {
    ...
    const types = [
        ...
        { key: 'Ordination Leave', idKey: 'ordination', total: 30, icon: 'church', color: 'from-orange-400 to-orange-300 text-white' },
        { key: 'Unpaid Leave', idKey: 'unpaid', total: 120, icon: 'wallet', color: 'from-gray-400 to-gray-300 text-white' }
    ];
